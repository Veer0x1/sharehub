...
const Stats = () => {
  return (
    <div><section className="p-6 my-6 bg-green-50 dark:bg-black dark:text-gray-100">
    <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
      <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
        ...
        <img src="https://img.icons8.com/ios-filled/50/null/rupee.png" className = "w-[50px]"/>
        </div>
        <div className="flex flex-col justify-center align-middle">
          <p className="text-3xl font-semibold leading-none">₹ 38 billion</p>
      ...
      <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
        ...
        <img src="https://img.icons8.com/ios-filled/50/null/coins.png"/>
        </div>
        <div className="flex flex-col justify-center align-middle">
