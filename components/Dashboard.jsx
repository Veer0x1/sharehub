      ...
      <div>
        ...
        <ul className="mt-8 space-y-2 tracking-wide">
          ...
          <li>
            ...
            >
              <img src="https://img.icons8.com/fluency/96/null/stocks-growth.png" className="h-5"/>
                {/* <path
                ...
                /> */}
              {/* </img> */}
              <span className="group-hover:text-green-600 dark:group-hover:text-green-600">Stocks</span>
            </a>
          </li>
          <li>
            <a
              ...
              className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 dark:text-gray-300"
            >
            <img src="https://img.icons8.com/fluency/96/null/bonds.png" className="h-5"/>
              {/* <svg
              ...
              <span className="group-hover:text-green-500 dark:group-hover:text-green-500">Bonds</span>
            </a>
          </li>
          <li>
            <a
              ...
              className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 dark:text-gray-300"
            >
              <img src="https://img.icons8.com/fluency/96/null/bitcoin-cryptocurrency.png" className = "h-5"/>
              <span className="group-hover:text-green-500 dark:group-hover:text-green-500">Crypto</span>
            </a>
          </li>
          <li>
            <a
              ...
              className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 dark:text-gray-300"
            >
              <img src="https://img.icons8.com/color/96/null/cash.png" className = "h-5"/>
              <span className="group-hover:text-green-500 dark:group-hover:text-green-500">Mutual Funds</span>
            </a>
          </li>
        </ul>
      </div>
      ...
      <div className="px-6 pt-6 2xl:container">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <img className="m-auto w-40 opacity-75"  src="https://img.icons8.com/external-vitaliy-gorbachev-lineal-color-vitaly-gorbachev/60/null/external-rupee-currency-vitaliy-gorbachev-lineal-color-vitaly-gorbachev.png"/>
              <div>
                <h5 className="text-center text-xl text-gray-600 dark:text-gray-300">Balance</h5>
                <div className="mt-2 flex justify-center gap-4">
                  <h3 className="text-5xl font-bold text-gray-700 dark:text-white">₹ 1M</h3>
          ...
          <div>
            <div className="h-full group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
              <h5 className="text-xl text-gray-700 dark:text-gray-300">Invested Value </h5>
              <div className="my-8">
                <h1 className="text-5xl font-bold text-gray-800 dark:text-white">₹ 0.00</h1>
                <span className="text-gray-500 dark:text-gray-400">Last Week's Investment  </span>
              </div>
              <svg
                className="w-full"
                viewBox="0 0 218 69"
          ...
          <div>
            <div className="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10 lg:h-full">
              ...
              <div className="mt-6">
                <h5 className="text-center text-xl text-gray-700 dark:text-gray-300">Portfolio Value</h5>
                <div className="mt-2 flex justify-center gap-4">
                  <h3 className="text-3xl font-bold text-gray-700 dark:text-white">₹ 0.00</h3>
                  <div className="flex items-end gap-1 text-green-500">
                    <svg
                      className="w-3"
                      viewBox="0 0 12 15"
