...
const Footer = () => {
  return (
    <div>
      ...
      <footer className="w-full bg-gray-100 dark:bg-black py-16">
  <div className="md:px-12 lg:px-28">
    <div className="container m-auto space-y-6 text-gray-600 dark:text-gray-300">
      ...
      <div className="m-auto flex w-max items-center justify-between space-x-4">
        ...
        <a href="https://in.linkedin.com/company/linkedin" title="linkedin" target="blank" aria-label="linkedin">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            className="m-auto w-5"
      ...
      <div className="text-center">
        <span className="text-sm tracking-wide"
          >Copyright © ShareHub <span id="year"></span> | All right reserved</span
        >
      </div>
    </div>
  </div>
